...
<article>
	...
	<details class="question">
		...
		<p>
			...
			democratic self-governance. Millions of Americans relied on them before the welfare state and
	...
	<details class="question">
		...
		<p>
			This is the point. Power doesn't accumulate. There's no permanent ruling class, no political
			elite, no one whose career depends on maintaining power.
		</p>
		<p>
	...
	<details class="question">
		...
		<p>
			...
			consequences themselves, they're careful and humane. Abstract political positions become
			concrete human decisions.
		</p>
		<p>
	...
	<details class="question">
		...
		<p>
			...
			authority that can impose terms or extract rent.
		</p>
		<p>
			The software is open-source. You can inspect it, modify it, fork it. The data belongs to your
			community. Every decision made is based on what maximizes human flourishing. There are no dark
			patterns. There is no exploitation. There are no addictive mechanics.
		</p>
		<p>
	...
	<details class="question">
		...
		<p>
			...
			community's obligation to support you doesn't depend on your productivity. Everyone has
	...
	<details class="question">
		...
		<p>
			...
			themselves without state control.
		</p>
		<p>
