<script lang="ts">
	import { Button, Checkbox, EmptyState, Input, List, ListItem, PageHeader, Select } from '@bfs/ui';
	...
	<div class="layout">
		<aside class="filters">
			<form method="get" class="filter-form">
				...
				<div class="filter-section">
					<Checkbox name="negotiable" value="1" checked={filters.negotiable}>
						Negotiable only
					</Checkbox>
				</div>
				...
				<Button href="/classifieds" variant="secondary">Clear</Button>
			</form>
		</aside>
