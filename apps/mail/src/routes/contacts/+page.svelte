	...
	<div class="groups-list">
		{#if groups.length === 0}
			<div class="empty-state">
				<p>No contact groups yet. Create one to send messages to multiple people at once.</p>
			</div>
		{:else}
			{#each groups as group}
				<div class="group-card">
					{#if editingUuid === group.uuid}
						<!-- Edit Mode -->
					...
					{:else}
						...
						<div class="group-header">
							...
							<div class="group-actions">
								<button type="button" onclick={() => startEdit(group)} class="action-btn">
									Edit
								</button>
						...
						<div class="group-members">
							<div class="members-label">{group.members.length} member{group.members.length === 1 ? '' : 's'}:</div>
