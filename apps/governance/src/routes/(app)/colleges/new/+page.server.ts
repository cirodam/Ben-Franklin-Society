...
import { createAssociation, getAssociationByHandle } from '$lib/server/associations.js';
import { listEnactedMotions } from '$lib/server/motions.js';
...
export const actions: Actions = {
	create: async ({ request }) => {
		...
		try {
			const college = createAssociation({
				handle,
				name,
				abbreviation,
				type: 'college',
