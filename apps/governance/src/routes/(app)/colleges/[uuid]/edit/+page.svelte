...
<div class="page">
	<div class="page-header">
		<h1>Edit College</h1>
		<a href="/colleges/{data.association.uuid}" class="breadcrumb">← Back to {data.association.name}</a>
	</div>
	...
	<form method="POST" action="?/update" use:enhance class="form">
		...
		<div class="form-actions">
			<a href="/colleges/{data.association.uuid}" class="btn btn--ghost">Cancel</a>
