						...
						<tbody>
							{#each termHolders as t}
								<tr>
									<td>
										{#if t.person}
											<a href="/organization/people/{t.person.uuid}">{t.person.given_name} {t.person.family_name}</a>
		...
		{:else if activeTab === 'record'}
			<section class="section">
				...
				{:else}
					...
					<p class="record-link"><a href="/communications/record">View full record →</a></p>
				{/if}
			</section>
		{/if}
	</div>
