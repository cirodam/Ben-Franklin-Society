...
<div class="page">
	<header class="header">
		<div class="header__content">
			<a href="/organization/committees/{committeeUuid}/meetings" class="back-link">← Back to Meetings</a>
						...
						<div class="agenda-item">
							...
							<div class="agenda-item__content">
								<div class="agenda-item__header">
									<a href="/governance/motions/{item.motion_uuid}" class="agenda-item__title">
										{item.motion_title}
