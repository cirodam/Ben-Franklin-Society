...
<div class="page">
	<div class="page-header">
		...
		<p class="subtitle">The sovereign governing body of the society.</p>
	</div>
	...
	<div class="stats">
		...
		<div class="stat">
			<div class="stat__value">{data.association.established_at?.slice(0, 10) ?? data.association.created_at.slice(0, 10)}</div>
