				...
				<section class="section">
					...
					<div class="cards">
						{#each activeDeliberations as motion}
							<a href="/governance/motions/{motion.uuid}" class="card card--deliberation">
		...
		{:else if activeTab === 'decisions'}
			{#if recentDecisions.length > 0}
				<section class="section">
					...
					<p class="archive-link"><a href="/governance/motions?body={association.uuid}">View full archive →</a></p>
				</section>
			{:else}
				<EmptyState
					icon="✅"
