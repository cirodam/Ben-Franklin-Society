...
import { loadOrgChartDocument } from './library.js';
import type { OrgChartContent } from './library-types.js';
...
export function applyOrgChartTemplate(
	...
	db.transaction(() => {
		...
		updateAssociation(associationUuid, { org_chart_slug: orgChartSlug });
	})();
